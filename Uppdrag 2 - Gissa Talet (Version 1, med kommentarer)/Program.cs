...
namespace Uppdrag_2___Gissa_Talet__Version_1__med_kommentarer_
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            else if (nr < 46)                               // OM användaren skriver in ett värde som är 46 eller mindre så händer följande
            {
            ...
            else if (nr > 100)                               // OM använder skriver ett tal som är över 100 så händer följande
            {
